...
function Show-LoginForm {
    ...
    $textBox3.Width = 200
    $loginForm.Controls.Add($textBox3)
    ...
    $loginForm.Controls.Add($textBox4)
    ...
    $textBox5.Width = 200
    $loginForm.Controls.Add($textBox5)
...
function Show-SuccessForm {
    ...
    $loginForm = New-Object system.Windows.Forms.Form
    $loginForm.Text = "Proxmox - Logged In"
    $loginForm.Width = 400
    ...
    $loginForm.Controls.Add($checkedListBox)
    ...
    $saveButton.Add_Click({
        ...
        $json | Out-File -FilePath "./testing/login/selected_nodes.json" -Encoding utf8
    ...
    $loginForm.Controls.Add($saveButton)
